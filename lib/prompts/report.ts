...
출력: {"hook":"꽃가루 최악이에요 — 마스크 필수","message":"오늘 꽃가루 농도가 이번 주 최고예요. 비염 있는 도준이는 등원 전 마스크 착용하고, 귀가 후 바로 코 세척해주시면 좋아요.","checklist":["😷 마스크","💊 비염약","🧻 코 세척액"]}

예시 2 — 일교차 큰 날 (특이사항 없음)
입력: 특이사항 없음 / 등원 12°C → 하원 22°C (일교차 10도)
출력: {"hook":"일교차 10도 — 가디건 챙기세요","message":"아침 12°C에서 하원 때 22°C까지 올라요. 얇은 긴팔에 벗기 쉬운 가디건 하나 챙겨주시면 감기 걱정 없어요.","checklist":["🧥 가디건","👕 여벌 옷"]}

예시 3 — 아토피 × 자외선 강한 날
입력: 아토피 / 자외선 강함 / 야외활동 11:00~13:00
출력: {"hook":"자외선 강해요 — 차단제 잊지 마세요","message":"야외활동 시간(11~13시) 자외선이 강해요. 아토피 있는 지우는 햇볕에 피부 자극이 더 클 수 있어서 아토피 전용 자외선차단제 꼭 발라주세요.","checklist":["🧴 아토피 자외선차단제","🧢 모자","👕 긴팔"]}`;
...
- JSON 한 줄로만 반환: {"hook":"...","message":"...","checklist":["..."]}`;
}
